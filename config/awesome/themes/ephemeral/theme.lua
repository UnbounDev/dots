...
--theme.taglist_bg_focus = "#ff0000"
 ...
 --Tasklist; ref: https://awesomewm.org/doc/api/classes/awful.widget.tasklist.html#Theme_variables
...
theme.tasklist_bg_minimize = theme.xforeground
...
-- When initialized like `beautiful.init(path/to/theme.lua)`,
-- all `theme` fields will be available under `beatutiful.<variable>`
return theme
